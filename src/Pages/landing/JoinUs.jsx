...
const JoinUs = () => {
  return (
    <>
      ...
      <div className='border-2 border-red-500 border-solid sticky z-10 bg-gradient-to-b from-[#ddf3ff] form-11%  to-[#FAFBFC]   to-100% w-full md:h-[18rem] h-[5rem]  -translate-y-[70%]    '></div>
